...
const LOCALIZATION = {
    tr: {
        ...
        // About Button
        aboutToggle: "Hakkımızda",
        aboutTitle: "Hakkımızda",
        aboutIrmakTitle: "Irmak Caran",
        aboutIrmakContent: "Merhaba, ben Irmak. Saint Benoit Fransız lisesinde 12. sınıf öğrencisiyim. Arkadaşım Zeynep Karademir'le Dünya Su Günü için başladığımız su projemiz daha da büyüyerek adı Between the Pipes olan İstanbul'un farklı semtlerinden gelen musluk sularının araştırdığımız bir projeye dönüştü. Projenin veri toplama ve analizi kısmıyla ilgilendim. Bu proje sayesinde veri analizi, veri sunumu ve analitik düşünme gibi alanlarda kendimi geliştirdiğimi düşünüyorum. Üniversitede bu projeden edindiğim bilgilerden yardım da alarak işletme veya ekonomi okumak istiyorum.",
        aboutZeynepTitle: "Zeynep Karademir",
        aboutZeynepContent: "Merhaba, ben Zeynep. Şu anda Saint Benoit Fransız Lisesi'nde 12. sınıf öğrencisiyim. Fen ağırlıklı eğitimimle Between the Pipes'taki çalışmalarımızın birleşimi oldukça eğitici bir süreç oldu. Laboratuvar protokolüne aşina olmamda oldukça katkısı olan bir projeydi. Multidisipliner çalışmalara olan ilgim beni üniversitede kimya ve biyolojinin harmanlandığı bir alan olan eczacılığa yönlendiriyor.",
        aboutOzanTitle: "Ozan Gürleyen",
        aboutOzanContent: "Merhaba, 2024 yılında Saint Benoit Fransız Lisesi'nden mezun oldum ve şu anda eğitimime Liverpool Üniversitesi'nde Game Design bölümünde devam ediyorum. Oyun tasarımının yanı sıra yapay zeka ve veri analizi gibi alanlara yoğunlaşmaktayım ve Between the Pipes'ın veri sunumu konusunda çalıştım.",
        aboutFooter: "Between the Pipes",
    ...
    en: {
        ...
        aboutTitle: "About Us",
        aboutIrmakTitle: "Irmak Caran",
        aboutIrmakContent: "Hello, I'm Irmak. I am a 12th-grade student at Saint Benoît French High School. Together with my friend Zeynep Karademir, we started a water project for World Water Day, which has grown into a project called Between the Pipes, where we analyze tap water samples from different districts of Istanbul. I focused on the data collection and analysis part of the project. Through this experience, I believe I have developed my skills in data analysis, data presentation, and analytical thinking. I plan to study business or economics at university, drawing on the knowledge I gained from this project.",
        aboutZeynepTitle: "Zeynep Karademir",
        aboutZeynepContent: "Hello, I'm Zeynep. I am currently a 12th-grade student at Saint Benoît French High School. Combining my science-oriented education with our work on Between the Pipes has been a very instructive process. It was a project that helped me become familiar with laboratory protocols. My interest in multidisciplinary studies is guiding me toward pharmacy — a field that combines chemistry and biology — for my university education.",
        aboutOzanTitle: "Ozan Gürleyen",
        aboutOzanContent: "Hello, I graduated from Saint Benoît French High School in 2024 and I am currently studying Game Design at the University of Liverpool. In addition to game design, I focus on areas such as artificial intelligence and data analysis, and I worked on the data presentation part of Between the Pipes.",
        aboutFooter: "Between the Pipes",
    ...
    fr: {
        ...
        // About Button
        aboutToggle: "À propos de nous",
        aboutTitle: "À propos de nous",
        aboutIrmakTitle: "Irmak Caran",
        aboutIrmakContent: "Bonjour, je m'appelle Irmak. Je suis élève de terminale au lycée français Saint Benoît. Avec mon amie Zeynep Karademir, nous avons commencé un projet sur l'eau à l'occasion de la Journée mondiale de l'eau, qui s'est ensuite développé pour devenir Between the Pipes, un projet dans lequel nous analysons les eaux du robinet provenant de différents quartiers d'Istanbul. Je me suis occupée de la collecte et de l'analyse des données. Grâce à cette expérience, j'ai pu améliorer mes compétences en analyse de données, en présentation des résultats et en pensée analytique. J'aimerais étudier le commerce ou l'économie à l'université, en m'appuyant sur les connaissances acquises grâce à ce projet.",
        aboutZeynepTitle: "Zeynep Karademir",
        aboutZeynepContent: "Bonjour, je m'appelle Zeynep. Je suis actuellement élève de terminale au lycée français Saint Benoît. La combinaison de ma formation scientifique et du travail effectué sur Between the Pipes a été un processus très enrichissant. Ce projet m'a permis de mieux me familiariser avec le protocole de laboratoire. Mon intérêt pour les études multidisciplinaires m'oriente vers la pharmacie — un domaine qui combine la chimie et la biologie — pour mes études universitaires.",
        aboutOzanTitle: "Ozan Gürleyen",
        aboutOzanContent: "Bonjour, j'ai obtenu mon diplôme du lycée français Saint Benoît en 2024 et je poursuis actuellement mes études à l'Université de Liverpool, en Game Design. En plus de la conception de jeux vidéo, je m'intéresse à l'intelligence artificielle et à l'analyse de données, et j'ai travaillé sur la partie présentation des données du projet Between the Pipes.",
        aboutFooter: "Between the Pipes",
